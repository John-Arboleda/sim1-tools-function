...
const arrayTi: number[] = [0, 0, 0, 0, 6, 0, 0, 0, 11, 16];
const ti: number[][] = arrayToMatrix(arrayTi, [I, V]);

const arrayTf: number[] = [30, 11, 11, 26, 26, 0, 11, 11, 26, 26];
const tf: number[][] = arrayToMatrix(arrayTf, [I, V]);

const VAC: number[] = [0, 0.35, 0.35, -0.35, -0.35];
const VFC: number[] = [0, 0.35, 0.35, -0.35, -0.35];
const tc1: number[] = [0, 0, 0, 0, 0];
const tc2: number[] = [1, 5, 5, 5, 5];
...
const eta: number = 1;
const lambda: number[] = [0, 1, 0, 0];
const gamma: number[] = [0.09, 0.15, 0.05];
const Top: number = 6;
const st: number = 0;
...
const RN: number[] = [0.10, 0.10];
const LO: number[] = [0.10, 0.90, 0.00];
const rate: number = 0.2682;
const per: number = 5;
